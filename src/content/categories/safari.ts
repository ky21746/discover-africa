...
export const safari: Attraction[] = [
...

  {
    ...
    subtitle: "אחד האזורים הפראיים והבתוליים ביותר באוגנדה\nשילוב יוצא דופן של יערות גשם טרופיים, סוואנות לחות ומעיינות חמים גיאותרמיים",
    category: "safari",
    region: "מערב",
    description: "שמורת עמק סמוליקי (Semliki Valley Wildlife Reserve)\n\nשמורת עמק סמוליקי היא מהעתיקות באוגנדה ומשמרת נופים דרמטיים של סוואנות, יערות טרופיים ומקווי מים. השמורה מהווה חיבור ייחודי בין נופי יער הקונגו לבין סוואנות מזרח אפריקה, ומציעה חוויה נדירה של מגוון עצום של בעלי חיים וציפורים.\n\nבשטח השמורה חיים פילים, תאו, בופאלו, אנטילופות, קופים ושימפנזים, לצד עושר יוצא דופן של יותר מ־440 מיני עופות. מעבר לכך, סמוליקי מפורסמת במעיינות החמים הגיאותרמיים שלה, מוקדי עניין מיוחדים המושכים חוקרים ומטיילים מכל העולם.\n\nהודות לשילוב הנופים והמערכות האקולוגיות, השמורה מספקת חוויה מרתקת ואותנטית לאוהבי טבע, צילום וצפרות.\n\nמה תגלו בדרך:\n• סוואנות פתוחות עם עדרי פילים, תאו ובופאלו\n• קופי קולובוס ושימפנזים חופשיים בטבע\n• יותר מ־440 מיני עופות, כולל מינים נדירים\n• מעיינות חמים גיאותרמיים עם בריכות מבעבעות\n• נופים דרמטיים המשלבים את הרי הקונגו עם הסוואנות האפריקאיות",
    ...
    importantInfo: [
      "🌦️ **עונות השנה**",
      "• ניתן לטייל בפארק סמוליקי לאורך כל השנה",
      "• עונה יבשה (דצמבר–פברואר, יוני–ספטמבר): דרכי הגישה נוחות יותר, מסלולי ההליכה פתוחים, וצפייה בבעלי חיים קלה",
      "• עונה רטובה (מרץ–מאי, אוקטובר–נובמבר): הנוף ירוק ושופע במיוחד, מתאים לצפרות ולצילום, אך הדרכים עשויות להיות בוציות",
      "",
      "🚗 **נסיעה והגעה**",
      "• הפארק ממוקם במערב אוגנדה, סמוך לגבול עם קונגו",
      "• נסיעה יבשתית: כ־6–7 שעות מקמפלה ברכב פרטי",
      "• טיסות פנימיות: עם Bar Aviation מאנטבה או קאג'אנסי אל מנחת סמוליקי (Semliki Airstrip)",
      "",
      "🛣️ **שערי כניסה**",
      "• Sempaya Gate – שער מרכזי, דרכו נכנסים לרוב הסיורים התרמיים",
      "• Toro Gate – שער נוסף בצפון, מתאים לטרקים וצפייה בנופים",
      "",
      "🎯 **חוויות ייחודיות**",
      "• מעיינות חמים סמפאיה (Sempaya Hot Springs) – פעילות וולקנית ייחודית באוגנדה",
      "• צפרות נדירה – מעל 400 מינים, חלקם אנדמיים לאזור קונגו",
      "• תרבות הבטווה (Batwa Pygmies) – מפגש עם קהילות מקומיות ושימור מסורת",
      "• טרקים קצרים ביער הגשם הטרופי, צפייה בקופים ופרפרים",
      "",
      "⏱️ **משך שהות מומלץ**",
      "• יומיים–שלושה – מספיקים כדי לשלב סיורים במעיינות החמים, צפרות ותרבות מקומית",
      "• ניתן לשלב כחלק מטיול ארוך יותר בפארקים הסמוכים",
      "",
      "💡 **הידעת?**",
      "• בפארק סמוליקי נמצא המעיין החם ביותר באוגנדה – המים רותחים עד מעל 100 מעלות",
      "• זהו אחד המקומות המעטים במדינה בהם ניתן לראות יער גשם טרופי אמיתי בגובה נמוך",
      "",
      "🌦️ **עונות השנה**",
