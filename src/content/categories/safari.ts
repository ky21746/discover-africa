...
export const safari: Attraction[] = [
  {
    ...
    category: "safari",
    region: "מערב אוגנדה",
    description: "הפארק נחשב לאחד האתרים הפופולריים ביותר באוגנדה, עם נוף מגוון מאוד הכולל סוואנות, אגמים, יערות טרופיים ומכתשי געש. הוא משתרע על שטח של כ־1,978 קמ\"ר, מה שהופך אותו לשני בגודלו במדינה.\n\nייחודו המרכזי הוא שילוב בין עולם החי העשיר לבין נופים דרמטיים של הרי הרוונזורי. הוא בית ליותר מ־95 מיני יונקים ולמעלה מ־600 מיני ציפורים, מה שמציב אותו בראש אתרי הצפרות באפריקה.\n\nבין האטרקציות המפורסמות ביותר נמצאים אריות המטפסים על עצים בסקטור איששה, תופעה נדירה וייחודית. תעלת קזינגה, המחברת בין אגם אדוארד לאגם ג'ורג', ידועה כריכוז אחד הצפופים בעולם של היפופוטמים ותניני הנילוס.\n\nבמהלך סיורים בסירה ניתן לצפות מקרוב בבעלי חיים השותים על גדות התעלה. הפארק נגיש יחסית ומשולב ברוב מסלולי התיירות הקלאסיים באוגנדה, ולכן מקבל נפח ביקור גבוה מאוד.\n\nהכרה בינלאומית קיבלה הפארק כאשר הוכרז כשמורת ביוספרה של אונסק\"ו בשל המגוון הביולוגי יוצא הדופן.",
