...
export const safari: Attraction[] = [
  {
    ...
    infoGrid: {
      seasons: [
        "דצמבר-פברואר: עונה יבשה - חיות סביב מקורות מים, נוף צהוב",
        "יוני-ספטמבר: עונה יבשה - תנאים אופטימליים לצפייה",
        "מרץ-מאי: עונה רטובה - נוף ירוק, דרכים קשות",
        "אוקטובר-נובמבר: עונה רטובה - פחות מבקרים, מחירים נמוכים יותר"
      ],
      access: [
        "מקמפלה: 6-7 שעות נסיעה דרך פורט פורטל",
        "הנסיעה עוברת באגמים קטנים ושדות תה",
        "ניתן לצפות בעדרי אנקולה (בקר מקומי עם קרניים ענקיות)",
        "אפשרות טיסה פנימית לקאססה (45 דקות)"
      ],
      gates: [
        "קאטונגו - קרוב לעיירות וללודג'ים נוחים",
        "איששה - מאפשר המשך ישיר לבווינדי ולגורילות",
        "קזונגו - צמוד לשייט בתעלת קזינגה",
        "כל השערים פתוחים 6:00-18:00"
      ],
      experiences: [
        "אריות מטפסי עצים בסקטור איששה - תופעה נדירה וייחודית",
        "תעלת קזינגה - ריכוז צפוף של היפופוטמים ותניני הנילוס",
      ...
      duration: [
        "2-3 ימים מומלצים לחוויה מלאה",
        "כולל ספארי יבשתי, שייט בתעלת קזינגה",
        "טיול ביער קיאמבורה לצפייה בשימפנזים",
        "יום אחד מספיק רק לטעימה בסיסית"
      ],
      didYouKnow: [
        "הפארק נקרא על שם המלכה אליזבת השנייה שביקרה בו ב-1954",
        "אחד משני הפארקים הלאומיים היחידים בעולם עם אריות מטפסי עצים",
        "מתמודד עם אתגרי ביטחון בשל קרבתו לגבול עם קונגו",
        "מומלץ לבקר בו רק בליווי מדריכים מוסמכים"
      ]
    }
  },
