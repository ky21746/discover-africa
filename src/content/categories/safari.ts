...
export const safari: Attraction[] = [
  {
    ...
    infoGrid: {
      ...
      gates: [
        "Katunguru – שער מרכזי בסמוך לתעלת קזינגה",
        "Kichwamba – שער מזרחי קרוב למכתשי הלבה",
        "Ishasha – שער דרומי לאזור האריות המטפסים"
      ],
      experiences: [
