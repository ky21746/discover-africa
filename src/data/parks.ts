...
export const parks: Park[] = [
  // ===== Safari (National Parks) =====
  {
    ...
    infoGrid: {
      ...
      gates: [
        "Katunguru – שער מרכזי סמוך לתעלת קזינגה",
  ...
  },
  {
    ...
    cost_est: "$$",
    season: "כל השנה",
    highlights: ["מפלי מורצ׳יסון", "שייט בנילוס", "עדרי פילים"],
    combos: ["ziwa-rhino"],
    summary: "פארק ענק עם מפלים עוצמתיים וספארי עשיר.",
    description: "הפארק הגדול במדינה – שילוב סוואנה ונילוס עם מגוון חיות.",
