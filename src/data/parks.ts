...
export const parks: Park[] = [
...
},
  {
    ...
    importantInfo: [
      "מיקום: פארק מגהינגה נמצא בדרום-מערב אוגנדה, על הגבול עם רואנדה וקונגו, באזור הרי הגעש",
      "גודל הפארק: פארק קטן יחסית (33.7 קמ\"ר) מה שהופך אותו לשקט יותר מבווינדי",
      "עונות מומלצות: יוני–ספטמבר ודצמבר–פברואר - עונות יבשות עם מזג אוויר נוח יותר לטרקים",
      "נסיעה והגעה: כ-8-9 שעות נסיעה מקמפלה. הדרך עוברת דרך נוף הררי מרהיב",
      "יתרונות על בווינדי: פחות תיירים, אווירה רגועה יותר, נופים וולקניים מרהיבים",
      "טרק גורילות: משך הטרק 2-8 שעות, תלוי במיקום המשפחה. מומלץ להתחיל מוקדם בבוקר",
      "מספר משפחות: יש משפחה אחת של גורילות הרים בפארק (Nyakagezi family)",
      "רמת קושי: בינונית-גבוהה, דורש כושר טוב. הגובה נע בין 2,227-4,127 מטר",
      "ציוד נדרש: נעלי הליכה טובות, בגדים חמים, מטריה, מים ומזון קל",
      "תנאי מזג אוויר: יכול להיות קריר ורטוב, חשוב להביא שכבות בגדים",
      "עלות: דומה לבווינדי - כ-700$ לאדם (2024), כולל רישיון, מדריך וריינג'רים",
      "גיל מינימלי: 15 שנים לטרק גורילות",
      "לינה: אפשרויות לינה מוגבלות באזור, מומלץ לתכנן מראש"
    ]
  },
  {
    slug: "kibale-chimps",
  ...
  },
  {
    ...
    importantInfo: [
      ...
      "נסיעה והגעה: הפארק נמצא כ-305 ק\"מ מקמפלה, נסיעה של 4–5 שעות ברכב. ניתן להגיע גם בטיסה פנימית (כ-1 שעה) משדה התעופה אנטבה למנחתי פאקובה או בוגונגו",
      "יש לקחת בחשבון מעבר במעבורת בין הגדה הדרומית לצפונית של הנילוס. טיסות פנימיות: מופעלות על ידי Bar Aviation משדות התעופה Entebbe/Kajjansi",
      "שערי כניסה: דרומיים: קיצ'ומבניובו (Kichumbanyobo), בוגונגו (Bugungu) – כולל מסלול נופי דרך יער בודונגו והשבר הסורי-אפריקאי",
      "צפוניים: טנגי (Tangi), וונקוואר (Wankwar), צ'ובה (Chobe) – נוחים למטיילים המגיעים מקידפו או מגולו",
      "חוויות ייחודיות: מפלי מורצ'יסון – הנילוס נדחס למעבר של 8 מטר בלבד, מחזה עוצמתי",
      "שייט בסירה לבסיס המפלים או לדלתת הנילוס – מפגש מרשים עם היפופוטמים, תנינים וציפורים",
      "ספארי יבשתי – אריות, פילים, ג'ירפות, באפלו ועוד מגוון רחב של חיות בר",
      "צפרות – הפארק ידוע במגוון הציפורים שלו, כולל ציפורים אנדמיות לאזור"
    ]
  },
  {
    slug: "kidepo",
  ...
  },
  {
    ...
    importantInfo: [
      "מיקום: הפארק נמצא במערב אוגנדה, על הגבול עם הרפובליקה הדמוקרטית של קונגו, בעמק אלברטין",
      "אקלים: הפארק נמצא באזור חם ולח עם טמפרטורות גבוהות לאורך כל השנה. הלחות גבוהה במיוחד",
      "עונות מומלצות: עונה יבשה (דצמבר–פברואר, יוני–אוגוסט) עדיפה לביקור, עם פחות גשמים ושבילים נוחים יותר",
      "נסיעה והגעה: כ-6-7 שעות נסיעה מקמפלה. הדרך עוברת דרך נוף הררי מרהיב של הרי רוונזורי",
      "חוויות ייחודיות: מעיינות חמים טבעיים - חוויה מיוחדת של רחצה במים חמים טבעיים",
      "צפרות: הפארק ידוע בצפרות מעולה, עם ציפורים מערב-אפריקאיות נדירות שלא ניתן לראות במקומות אחרים באוגנדה",
      "יער טרופי: יער נמוך חם-לח עם מגוון עצים וצמחים טרופיים",
      "חיות בר: למרות שהפארק קטן יחסית, יש בו מגוון חיות בר כולל קופים, ציפורים וחיות קטנות",
      "מסלולי הליכה: מספר מסלולי הליכה קצרים המתאימים למשפחות",
      "לינה: אפשרויות לינה מוגבלות באזור, מומלץ לתכנן מראש"
    ]
  },
  ...
  // ===== Mountains =====
  {
    ...
    importantInfo: [
      "מיקום: הר אלגון נמצא במזרח אוגנדה, על הגבול עם קניה, במחוז מבאלה",
      "גובה: זהו ההר הרביעי בגובהו באפריקה, עם פסגה של 4,321 מטר",
      "עונות מומלצות: דצמבר-פברואר ויוני-ספטמבר - עונות יבשות עם מזג אוויר נוח יותר לטרקים",
      "נסיעה והגעה: כ-4-5 שעות נסיעה מקמפלה. הקרבה לעיר מבאלה מקלה על הגישה",
      "חוויות ייחודיות: קלדרה עצומה - מהגדולות בעולם, שניתן לטייל בה ברגל",
      "מפלי סיפי: מפלים מרהיבים במורדות ההר, מהווים יעד תיירותי בפני עצמו",
      "טרקים: מסלולים נחשבים נוחים יותר מרוונזורי אך עדיין דורשים כושר טוב",
      "חיות בר: במהלך טרקים ניתן לפגוש אנטילופות קטנות, קופים ולעיתים פילים",
      "אקלים: מזג אוויר קריר בגבהים, חשוב להביא ציוד מתאים",
      "לינה: אפשרויות לינה מגוונות בסביבת מבאלה ומפלי סיפי",
      "פעילויות נוספות: טעימות קפה מקומי, מפגשים עם קהילות סביי, טיפוס בסלע"
    ]
  },
